...
-- ----------------------------
INSERT INTO `flyway_schema_history` (`installed_rank`, `version`, `description`, `type`, `script`, `checksum`, `installed_by`, `installed_on`, `execution_time`, `success`) VALUES (1, '1', 'init schema', 'SQL', 'V1__init_schema.sql', 753257081, 'root', '2026-06-03 19:14:12', 25, 1);
